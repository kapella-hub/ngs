...
-- Note: Password hash will be regenerated by API on first startup
INSERT INTO users (username, email, password_hash, display_name, role) VALUES
    ('admin', 'admin@example.com', '$2b$12$dummy.hash.will.be.replaced.by.api.startup.seed', 'NGS Admin', 'admin')
